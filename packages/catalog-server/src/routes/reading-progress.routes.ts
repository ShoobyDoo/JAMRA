...
export function createReadingProgressRoutes(deps: ServerDependencies): Router {
  ...
  router.post("/api/reading-progress", (req, res) =>
    controller.saveProgress(req, res),
  );
  router.get("/api/reading-progress/:mangaId/:chapterId", (req, res) =>
    controller.getProgress(req, res),
  );
  router.get("/api/reading-progress", (req, res) =>
    controller.getAllProgress(req, res),
  );
  router.get("/api/reading-progress/enriched", (req, res) =>
